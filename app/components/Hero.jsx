...
function Hero() {
  ...
  <div className="mx-auto max-w-xl text-center">
   <h1 className="text-3xl font-extrabold sm:text-5xl text-white">
    Muscle Generator
    <strong className="bg-gradient-to-r from-red-400 via-red-300 to-red-100 
    bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl"> Make It Pump 
    </strong>
   </h1>
...
>
  ...
  <span className="text-sm font-medium transition-all group-hover:me-4"> Get Started </span>
</Link>
