...
const Team = () => {
    ...
    return (
        <div className="container">
          ...
          <li>
            <a
              href="https://www.instagram.com/youssef_mohamed7100?igsh=MWdueHgyaXhqMWtzZA=="
              rel="noreferrer"
              target="_blank"
          ...
          <li>
            <a
              href="https://github.com/Carbona777"
              rel="noreferrer"
              target="_blank"
              className="text-white transition hover:opacity-75"
            >
      ...
      <div className="card">
        ...
        <div className="textbx">
          ...
          <li>
            <a
              href="https://www.facebook.com/share/zrNvF1L4xfBfLNKn/?mibextid=qi2Omg"
              rel="noreferrer"
              target="_blank"
              className="text-white transition hover:opacity-75"
            >
          ...
          <li>
            <a
              href="https://www.instagram.com/goodguyseif?igsh=MWd0N3pvZGlob3RwYg=="
              rel="noreferrer"
              target="_blank"
              className="text-white transition hover:opacity-75"
            >
    ...
    <div className="contentbx " id="content3">
      <div className="card">
        ...
        <div className="textbx">
          ...
          <li>
            <a
              href="https://www.facebook.com/fares.asraf.3?mibextid=ZbWKwL"
              rel="noreferrer"
              target="_blank"
              className="text-white transition hover:opacity-75"
            >
          ...
          <li>
            <a
              href="https://www.instagram.com/faresasraf?utm_source=qr&igsh=MTY2anh3ZTBhb3JrZw=="
              rel="noreferrer"
              target="_blank"
              className="text-white transition hover:opacity-75"
            >
    ...
    <div className="contentbx " id="content4">
      <div className="card">
        ...
        <div className="textbx">
          ...
          <li>
            <a
              href="https://www.facebook.com/share/M47Rs2RVXH2DPY4a/?mibextid=qi2Omg"
              rel="noreferrer"
              target="_blank"
              className="text-white transition hover:opacity-75"
            >
          ...
          <li>
            <a
              href="https://www.instagram.com/mohamed_saeed.o_o?igsh=MTRsb3BsN3czdXl2eQ=="
              rel="noreferrer"
              target="_blank"
              className="text-white transition hover:opacity-75"
            >
    ...
    <div className="contentbx " id="content5">
      <div className="card">
        ...
        <div className="textbx">
          ...
          <li>
            <a
              href="https://www.facebook.com/share/1Wji5KsvsDskyPy7/?mibextid=qi2Omg"
              rel="noreferrer"
              target="_blank"
              className="text-white transition hover:opacity-75"
            >
    ...
    <div className="contentbx " id="content6">
      <div className="card">
        ...
        <div className="textbx">
          ...
          <li>
            <a
              href="https://www.facebook.com/profile.php?id=100005275145270&mibextid=ZbWKwL"
              rel="noreferrer"
              target="_blank"
              className="text-white transition hover:opacity-75"
            >
          ...
          <li>
            <a
              href="https://www.instagram.com/ahmedsamir6368?igsh=MXZpMmR4ZTQ2bGlrNg=="
              rel="noreferrer"
              target="_blank"
              className="text-white transition hover:opacity-75"
            >
