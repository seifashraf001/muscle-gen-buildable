  ...
  return (
    <footer className="bg-black dark:bg-primary">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-4 rounded-lg bg-gradient-to-r from-red-900 via-red-700 to-orange-700 p-6 shadow-lg sm:flex-row sm:justify-between">
          <strong className="text-xl text-white sm:text-xl">Start your fitness journey now!</strong>
...
>
        ...
        <div className="mt-16">
          ...
          <div className="mt-16 sm:flex sm:items-center sm:justify-between">
            <div className="flex justify-center text-teal-600 sm:justify-start dark:text-teal-300"></div>
