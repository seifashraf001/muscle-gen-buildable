          ...
          <div className="flex items-center gap-4">
            ...
            {session ? (
              <div className="relative">
                ...
                >
                  <img
                    src="https://i.imgur.com/niqMFrk.png"
                    alt="Profile"
                ...
                {isOpen && (
                  <div className="absolute mt-2 right-0 left-auto w-max bg-gray-900 rounded-md shadow-lg py-1">
                      <div className='mt-1'>
                        <h4 className="m-2 text-white hover:bg-gray-700 transition cursor-pointer rounded p-1"> <span className='text-neutral-400'>Name:</span> <span>{session?.user?.name}</span></h4>
                        <h4 className="m-2 text-white hover:bg-gray-700 transition cursor-pointer rounded p-1"> <span className='text-neutral-400'>Email:</span> <span>{session?.user?.email}</span></h4> 
                      </div> 
