  ...
  const calculateCalories = () => {
    ...
    if (
      ...
      if (gender === "male") {
        ...
        const baseCalories =
          655 + 9.563 * parseFloat(weight) + 1.85 * parseFloat(height) - 4.676 * parseFloat(age);
        switch (activity) {
          case "1":
            result = Math.round(1.2 * baseCalories);
            break;
      ...
      <div className="max-w-md mx-auto">
        <div className="content bg-black shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label htmlFor="weight" className="block text-white text-sm font-bold mb-2">
                Weight (kg)
              </label>
              <input
                type="number"
            ...
            <div className="mb-4">
              <label htmlFor="height" className="block text-white text-sm font-bold mb-2">
                Height (cm)
              </label>
              <input
                type="number"
            ...
            <div className="mb-4">
              <label htmlFor="activity" className="block text-white text-sm font-bold mb-2">
                Activity
              </label>
              <select
                id="activity"
            ...
            <div className="mb-6">
              <button
                type="submit"
                className="bg-gradient-to-r from-red-900 via-red-700 to-orange-700 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full"
              >
                Calculate
              </button>
            </div>
          ...
          <div
            ...
            style={{ display: totalCalories ? "block" : "none" }}
          >
