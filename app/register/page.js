          ...
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <form onSubmit={handleSubmit} className="mt-10 grid grid-cols-6 gap-10">
              <div className="col-span-6 ">
                <label htmlFor="name" className="relative block overflow-hidden rounded-md border border-gray-200 px-3 pt-3 shadow-sm focus-within:border-blue-600 focus-within:ring-1 focus-within:ring-blue-600 dark:border-white dark:bg-white">
                <span
...
Password Confirmation
              ...
              <div className="col-span-6">
                <p className="text-sm text-white dark:text-white">
                  ...
                  and
                  <a href="register/Privacy" className="text-white underline dark:text-white"> privacy policy </a>.
                </p>
              </div>
